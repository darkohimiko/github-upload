...
<%
    ...
    String strFieldCode1Choose  = getField(request.getParameter( "FIELD_CODE1_CHOOSE_L" ));
    String strFieldOrder1Choose = getField(request.getParameter( "FIELD_ORDER1_CHOOSE_L" ));
    String strFieldCode2Choose  = getField(request.getParameter( "FIELD_CODE2_CHOOSE_L" ));
    String strFieldOrder2Choose = getField(request.getParameter( "FIELD_ORDER2_CHOOSE_L" ));
	...
	String	screenLabel     = lb_field_log;
    ...
    if( strMode.equals("SETKEY") ) {
        ...
        con1.addData( "INDEX_TYPE",   "String", "G" );
        ...
        con.addData( "INDEX_TYPE",   "String", "G" );
...
function window_onload() {
	...
	lb_field_log.innerHTML          = lbl_field_log
    ...
    if( lastRowSelect2 != "" ) {
    	rowSelected( "typeG", lastRowSelect2 );
    }else {
...
function afterCheckSelect( lv_result ) {
	if( lv_result == "true" ) {
		...
		//alert("ø‘≈¥Ïπ’È∂Ÿ°‡≈◊Õ°‡ªÁπø‘≈¥Ï Log ·≈È«");
		alert( lc_this_field_selected_log_field );
	}
}
...
<body onLoad="MM_preloadImages('images/btt_save2_over.gif','images/btt_back_over.gif');window_onload();">
...
%>
			            ...
			            <tr>
			            	<td>
								...
								<input type="hidden" id="FIELD_ORDER1_CHOOSE_L" name="FIELD_ORDER1_CHOOSE_L" value="<%=strLastRowSelect2 %>">
								<input type="hidden" id="FIELD_ORDER2_CHOOSE_L" name="FIELD_ORDER2_CHOOSE_L" value="">
								<input type="hidden" id="FIELD_CODE1_CHOOSE_L"  name="FIELD_CODE1_CHOOSE_L"  value="<%=strFieldCode1Choose %>">
								<input type="hidden" id="FIELD_CODE2_CHOOSE_L"  name="FIELD_CODE2_CHOOSE_L"  value="">
            ...
            <tr>
	           	<td align="center" colspan="4">
	           		<a href="#" onclick= "clickBack()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/btt_back_over.gif',1)">
...
var obj_fieldOrder1Choose = document.getElementById("FIELD_ORDER1_CHOOSE_L");
var obj_fieldOrder2Choose = document.getElementById("FIELD_ORDER2_CHOOSE_L");
var obj_fieldCode1Choose  = document.getElementById("FIELD_CODE1_CHOOSE_L");
var obj_fieldCode2Choose  = document.getElementById("FIELD_CODE2_CHOOSE_L");
