...
<%
    ...
    String strProjectCode 	= checkNull( request.getParameter( "PROJECT_CODE_LINK" ) );
    String strProjectName 	= getField( request.getParameter( "PROJECT_NAME_LINK" ) );
...
function click_search_desc(){
	if(form1.txtDOCUMENT_DESC.value == ""){
...
function set_concat_document_field(){
	...
	for( var intCount = 0 ; intCount < arrField.length ; intCount++ ){
		...
		if( objDocumentField != null && objDocumentField.name.indexOf( "DSP_" ) == -1 && objDocumentField.value.length > 0 ){
			...
			if((objDocumentField.getAttribute("value_type") == "date")&&(strConcatToDateFieldValue != "")){
				                ...
				                <td bgcolor="#f7f6f2">
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
			                    		<tr> 
						                    ...
						                    <td colspan="3"><input name="txtSEARCH_DESC" type="text" class="input_box" size="100" onkeypress="field_press(this)">
