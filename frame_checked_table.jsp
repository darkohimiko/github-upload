...
<%
    ...
    String strTableCodeKey = getField(request.getParameter("TABLE_CODE"));
	String strResult       = "";	
	...
	if( strMode.equals("SEARCH") ) {
        ...
        bolnSuccess = con.executeService( strContainerName, strClassName, "checkedTableCode" );
...
function window_onload() {
    ...
    parent.checkedResultTable( "<%=strTableCodeKey %>" );
