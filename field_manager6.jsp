...
<%
    ...
    String	screenLabel     = lb_field_link;
    ...
    if( strMode.equals("SETKEY") ) {
        ...
        con1.addData( "INDEX_TYPE",   "String", "L" );
        ...
        con.addData( "INDEX_TYPE",   "String", "L" );
...
function window_onload() {
	...
	lb_field_link.innerHTML         = lbl_field_link1
    ...
    if( lastRowSelect2 != "" ) {
    	rowSelected( "typeL", lastRowSelect2 );
    }else {
...
function afterCheckSelect( lv_result ) {
	if( lv_result == "true" ) {
		...
		//alert("ø‘≈¥Ïπ’È∂Ÿ°‡≈◊Õ°‡ªÁπø‘≈¥Ï‡™◊ËÕ¡‚¬ß·≈È«");
		alert( lc_this_field_selected_link_field );
	}
}
