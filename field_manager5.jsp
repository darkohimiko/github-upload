...
<%
	...
	String	screenLabel     = lb_field_report;
    ...
    if( strMode.equals("SETKEY") ) {
        ...
        con1.addData( "INDEX_TYPE",   "String", "R" );
...
//        	strFieldIndexOrder = strFieldIndexOrder.substring(strFieldIndexOrder.length()-8,strFieldIndexOrder.length());
    ...
    if(strMode.equals("SEARCH")){
        ...
        bolnSuccess = con.executeService( strContainerName , strClassName , "findFieldManagerReport" );
...
function window_onload() {
	...
	lb_field_report.innerHTML       = lbl_field_report
    ...
    if( lastRowSelect2 != "" ) {
    	rowSelected( "typeR", lastRowSelect2 );
    }else {
...
function afterCheckSelect( lv_result ) {
    if( lv_result == "true" ) {
            ...
            alert( lc_this_field_selected_report_field );
    }
}
    ...
    <td valign="top">
    	<table width="800" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
    			...
    			<div id="screen_div" style="width:665px;height:450px;overflow-y:scroll;overflow-x:hidden;margin-right:0px;margin-bottom:0px;border:0px #ccc solid;" >
