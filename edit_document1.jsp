...
function submit_form(){
	var projectFlag = form1.project_flag.value;
	
	form1.method = "post";
	if( projectFlag == "4" ) {
		//form1.action = "edit_document2_00000001.jsp";
		form1.action = "edit_document2_" + "<%=strProjectCode %>" + ".jsp";
	}else {
				...
				<!-- ---------------------------------- DIV DATA-------------------------------------------- -->
					                ...
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
				                    	<tr> 
					                      	...
					                      	<td width="184"><input name="BATCH_NO" type="text" value="<%=strBatchNo %>" class="input_box" maxlength="12" onkeypress="keypress_number();field_press( this );"></td>
					                      	<td width="275">&nbsp;</td>
					                    ...
					                    <tr> 
					                      	...
					                      	<td width="459" colspan="2"><input name="DOCUMENT_NAME" type="text" value="<%=strDocumentName %>" class="input_box" maxlength="500" size="55" onkeypress="field_press( this );"></td>
					                      	<!-- td width="275">&nbsp;</td -->
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input name="ADD_DATE" type="text" value="<%=strAddDate %>" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                        	<a href="javascript:showCalendar(form1.ADD_DATE,<%=strLangFlag %>)"><img src="images/calendar.gif" width=16 height=16 align="absmiddle" border=0 ></a> 
				                       			<%=lb_to_date %> </td>
					                      	<td><input name="TO_ADD_DATE" type="text" value="<%=strToAddDate %>" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                    ...
					                    <tr> 
					                      	<td><%=lb_edit_date %></td>
					                      	<td><input name="EDIT_DATE" type="text" value="<%=strEditDate %>" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
				                        		...
				                        		<%=lb_to_date %> </td>
					                      	<td><input name="TO_EDIT_DATE" type="text" value="<%=strToEditDate %>" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input id="txtDocUser" name="txtDocUser" type="text" value="<%=strDocUser %>" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td>
					                      		<input id="txtDocUserName" name="txtDocUserName" type="text" value="<%=strDocUserName %>" class="input_box_disable" size="45" readonly>
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input id="ADD_USER" name="ADD_USER" type="text" value="<%=strAddUser %>" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td><input id="ADD_USER_NAME" name="ADD_USER_NAME" type="text" value="<%=strAddUserName %>" class="input_box_disable" size="45" readonly></td>
				                    	...
				                    	<tr> 
					                      	<td><%=lb_edit_user %></td>
					                      	<td><input id="EDIT_USER" name="EDIT_USER" type="text" value="<%=strEditUser %>" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td><input id="EDIT_USER_NAME" name="EDIT_USER_NAME" type="text" value="<%=strEditUserName %>" class="input_box_disable" size="45" readonly></td>
					                      	<td>
		...
		if(bolFieldSuccess) {
			...
			while( con.nextRecordElement() ){
				...
				if( strFieldType.equals( "CHAR" ) ){
					...
					strTag += "\n &nbsp;&nbsp;" + lb_to_date + " &nbsp;<input type=\"text\" name=\"TO_" + strFieldName + "\" value=\"\" class=\"input_box_disable\" size=\"10\" maxlength=\"10\" value_type=\"date\" is_PK=\"" + strIsPK + "\" is_NotNull=\"" + strIsNotNull + "\" onKeypress=\"keypress_number();\" onBlur=\"set_format_date( this );\" readOnly>";
					...
					strTag += "\n &nbsp;&nbsp;" + lb_to_date + " &nbsp;<input type=\"text\" name=\"TO_" + strFieldName + "\" value=\"\" class=\"input_box_disable\" size=\"10\" maxlength=\"10\" value_type=\"date_eng\" is_PK=\"" + strIsPK + "\" is_NotNull=\"" + strIsNotNull + "\" onKeypress=\"keypress_number();\" onBlur=\"set_format_date( this );\" readOnly>";
					//strTag += "\n<a href=\"javascript:showCalendar(form1.TO_" + strFieldName + "," + strLangFlag + ")\"><img id=\"img_" + strFieldName + "\" src=\"images/calendar.gif\" width=16 height=16 align=\"absmiddle\" border=0 style=\"display:none\" ></a>";
				                ...
				                <td bgcolor="#f7f6f2">
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
			                    		<tr> 
						                    ...
						                    <td colspan="3">
						                    	<input name="txtSEARCH_DESC" type="text" value="<%=strSearchDesc %>" class="input_box" size="100" onkeypress="field_press(this)">
