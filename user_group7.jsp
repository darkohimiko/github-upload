...
<%
    ...
    String strUserGroupKey  = getField( request.getParameter("USER_GROUP") );
    ...
    if( strMode.equals("INSERT") ) {
        ...
        con.addData( "UPD_USER",     "String", strUserId);
            bolnSuccess = con.executeService( strContainerName, strClassName, "insertGroupAccessByOwnerUser" );
            if( !bolnSuccess ) {
    ...
    if( strMode.equals("SEARCH") ) {
        ...
        bolnSuccess = con.executeService( strContainerName, strClassName, "selectOwnerUserByOrg" );
...
<%
    if( bolnSuccess ) {
        ...
        while( con.nextRecordElement() ) {
            ...
            con1.addData( "PROJECT_CODE", "String", strProjCodeKey );
            con1.addData( "USER_GROUP",   "String", strUserGroupKey );
            con1.addData( "USER_ID",      "String", strFieldUserIdData );
            bolnSuccess2 = con1.executeService( strContainerName, strClassName, "countGroupAccessByOwnerUser" );
            

            strChkBox = "<input type=\"checkbox\" id=\"chkAllCheck" +intSeq+ "\" name=\"chkAllCheck" +intSeq +"\" onclick=\"chkbxClickValue()\" >";
            if( bolnSuccess2 ) {
                strChkBox = "<input type=\"checkbox\" id=\"chkAllCheck" +intSeq+ "\" name=\"chkAllCheck" +intSeq +"\" onclick=\"chkbxClickValue()\" checked=\"checked\">";
...
%>
                      <tr class="table_data1">
                        <td>&nbsp;</td>
                        <td><div align="center"><%=strChkBox %></div></td>
...
<%
 ...
 %>                      
			...
			<input type="hidden" id="USER_GROUP"   name="USER_GROUP"   value="<%=strUserGroupKey %>">
