...
<%
	...
	//if( strField1.length() != 0 ){
		...
		bolnSuccess = con.executeService( strContainerName , "USER_PROFILE" , "zoomDocumentUserName" );
		if( bolnSuccess ) {
...
function rowDblClick( objRow ){
	...
	if( opener != null || !opener.closed ){
		...
		var objColumnHid  = opener.document.getElementById( arrResultField[ 2 ] );
		...
		if( objColumnHid != null ){
			objColumnHid.value = objRow.getAttribute("COLUMN_ORG");
		}
...
function submitForm(){
	form1.method = "post";
	form1.action = "zoom_document_user.jsp";
	form1.submit();
}
...
<form name="form1">
  <table width="450" align="center" class="label_normal2" cellspacing="0">
    <tr>
  		<td height="12">
  		</td>
  	</tr>
    <tr>
      <td align="center"><table width="430" border="0" cellspacing="0">
        <tr>
<%
...
%>        
          <td width="100" height="22" class="hd_table"><%=lb_user_id%>&nbsp;<%=sortImg[1] %></td>
          <td width="155" height="22" class="hd_table"><%=lb_user_name%>&nbsp;<%=sortImg[2] %></td>
          <td width="175" height="22" class="hd_table"><%=lb_scan_org_combo%></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td align="center">
	    <table id="table1" width="430" border="0" cellspacing="0">
<%
	//if( strField1.length() != 0 ){
		if( !bolnSuccess ){
...
%>
		  <tr class="table_data1" <%=strScript%> align="left">
		    <td width="100" height="22" style="padding-left: 5px"><%=strUserId%></td>
		    <td width="155" height="22"><%=strFullName %></td>
		    <td width="175" height="22"><%=strOrgName%></td>
		  </tr>
<%
				}else{
%>
...
%>
		...
		<table width="430" border="0" cellpadding="0" cellspacing="0" class="footer_table">
           	<tr> 
