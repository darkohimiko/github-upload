...
<%
	...
	bolnSuccess = con.executeService( strContainerName, strClassName, "zoomTableLevel1" );
	if(bolnSuccess){
...
<html>
<head>
<title><%=lc_zoom_table_level1 %></title>
...
%>
          <td width="160" height="22" class="hd_table"><span id="lb_table_code"></span>&nbsp;<%=sortImg[1] %></td>
          <td width="150" height="22" class="hd_table"><span id="lb_table_name"></span>&nbsp;<%=sortImg[2] %></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
%>
		  <tr class="table_data1" <%=strScript%>>
		    <td width="160" height="22"><%=strColumnCode%></td>
		    <td width="150" height="22"><%=strColumnValue%></td>
		  </tr>
<%
			}else{
%>
...
%>					
				<tr class="table_data<%=intRem%2 + 1 %>" >
				    <td width="160" height="22" style="padding-left: 5px"></td>
