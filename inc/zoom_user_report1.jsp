...
<%
	...
	if( strField1.length() != 0 ){
		...
		if( strProjectFlag.length() != 0 ) {
			con.addData( "PROJECT_FLAG" , 	"String" , strProjectFlag );
		}
		...
		bolnSuccess = con.executeService( strContainerName , "USER_REPORT" , "zoomProjectManagerReport" );
		if(bolnSuccess){
...
function submitForm(){
	form1.method = "post";
	form1.action = "zoom_user_report1.jsp";
	form1.submit();
}

function window_onload(){

	//lb_zoom_1.innerHTML = lbl_zoom_1;
    //lb_zoom_2.innerHTML = lbl_zoom_2;
    //lb_zoom_3.innerHTML = lbl_zoom_3;
...
<form name="form1">
  <table width="340" align="center" class="label_normal2">
    <tr>
      <td><input type="text" name="FIELD1" class="input_box" size="50" value="<%=strField1%>" onFocus="this.select();" onKeypress="fieldPress( this );">
...
%>
          ...
          <td width="210" height="22" class="hd_table"><%=lb_project_name%>&nbsp;<%=sortImg[2] %></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
%>
		  <tr class="table_data1" <%=strScript%>>
		    <td width="100" height="22"><%=strProjectCode %></td>
...
%>
    ...
    <!-- tr>
	  <td><span id="lb_zoom_1"></span><img src="../images/search.gif" width="16" height="16" border="0"><span id="lb_zoom_2"></span></td>
	</tr>
	<tr>
	  <td><span id="lb_zoom_3"></span></td>
	</tr -->
  </table>
