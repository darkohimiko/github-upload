...
<%
	...
	String	strUserOrg    = checkNull(request.getParameter("USER_ORG"));
	String	strTotalPage  = "1";	
	String	strTotalSize  = "0";
	
	String strUserId = "" , strUserName = "", strUserSname = "";
	...
	if( strField1.length() != 0 ){
		...
		bolnSuccess = con.executeService( strContainerName , "USER_PROFILE" , "zoomUserName" );
		if(bolnSuccess){
...
function submitForm(){
	form1.method = "post";
	form1.action = "zoom_user_profile.jsp";
	form1.submit();
}
...
<form name="form1">
  <table width="340" align="center" class="label_normal2" cellspacing="0">
    ...
    <tr>
      <td align="center">
      	<input type="text" name="FIELD1" class="input_box" size="54" value="<%=strField1%>" onFocus="this.select();" onKeypress="fieldPress();">
...
%>        
          ...
          <td width="210" height="22" class="hd_table"><%=lb_user_name%>&nbsp;<%=sortImg[2] %></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
<%				
			...
			while( con.nextRecordElement() ){
				...
				strScript += " COLUMN_NAME=\"" + strUserName + " " + strUserSname + "\"";
...
%>
		  <tr class="table_data1" <%=strScript%> align="left">
		    ...
		    <td width="210" height="22"><%=strUserName + " " + strUserSname%></td>
		  </tr>
<%
				}else{
%>
...
%>
  ...
  <input type="hidden" name="USER_ORG" value="<%=strUserOrg%>">
