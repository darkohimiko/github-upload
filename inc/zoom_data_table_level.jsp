...
<%
	...
	String strTableLevel   = "";
	String strTableLevel1  = "";
	String strTableLevel2  = "";
	...
	bolnSuccess = con.executeService( strContainerName , "ZOOM_TABLE_MANAGER" , "zoomDataTable" );
	if(bolnSuccess){
...
function rowDblClick( objRow ){
	...
	if( opener != null || !opener.closed ){
		...
		var objTableLevelN = opener.document.getElementById( arrResultField[ 2 ] );
		var objTableLevel1 = opener.document.getElementById( arrResultField[ 3 ] );
		var objTableLevel2 = opener.document.getElementById( arrResultField[ 4 ] );
		...
		if( objTableLevelN != null ){
			objTableLevelN.value = objRow.getAttribute("TABLE_LEVEL");
		}
		if( objTableLevel1 != null ){
			objTableLevel1.value = objRow.getAttribute("TABLE_LEVEL1");
		}
		if( objTableLevel2 != null ){
			objTableLevel2.value = objRow.getAttribute("TABLE_LEVEL2");
		}
		opener.focus();
...
function submitForm(){
	form1.method = "post";
	form1.action = "zoom_data_table_level.jsp";
	form1.submit();
}

function window_onload(){
    lb_code.innerHTML   = lbl_table_code;
    lb_name.innerHTML   = lbl_table_name;
...
%>        
          ...
          <td width="210" height="22" class="hd_table"><span id="lb_name"></span>&nbsp;<%=sortImg[2] %></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
<%
			...
			while( con.nextRecordElement() ){
				...
				strScript += " TABLE_LEVEL=\"" + strTableLevel + "\"";
				strScript += " TABLE_LEVEL1=\"" + strTableLevel1 + "\"";
				strScript += " TABLE_LEVEL2=\"" + strTableLevel2 + "\"";
