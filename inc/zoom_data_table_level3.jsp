...
<%
	...
	String strTableLv2 	 	= request.getParameter( "TABLE_LV2" );
	String strTableLv2Label = getField( request.getParameter( "TABLE_LV2_LABEL" ) );
	String strTableLv2Code 	= request.getParameter( "TABLE_LV2_CODE" );
	String strTableLv2Name  = getField( request.getParameter( "TABLE_LV2_NAME" ) );
	...
	if( strField1.length() != 0 ){
		...
		con.addData( "TABLE_LV2" 	  , "String" , strTableLv2 );
		con.addData( "TABLE_LV2_CODE" , "String" , strTableLv2Code );
		...
		bolnSuccess = con.executeService( strContainerName , "ZOOM_TABLE_MANAGER" , "zoomDataTable3" );
		if(bolnSuccess){
...
function submitForm(){
	form1.method = "post";
	form1.action = "zoom_data_table_level3.jsp";
	form1.submit();
}
...
<form name="form1">
  <table width="340" align="center" class="label_normal2" cellspacing="0">
    ...
    <tr>
	  <td style="padding-left: 15px"><%=strTableLv2Label %> <span class="label_bold2"><%=strTableLv2Name%></span></td>
	</tr>
    <tr>
...
%>
  ...
  <input type="hidden" name="TABLE_LV2"		 value="<%=strTableLv2%>">
  <input type="hidden" name="TABLE_LV2_NAME" value="<%=strTableLv2Name%>">
  <input type="hidden" name="TABLE_LV2_CODE"  value="<%=strTableLv2Code%>">
  <input type="hidden" name="TABLE_LV2_LABEL" value="<%=strTableLv2Label%>">
