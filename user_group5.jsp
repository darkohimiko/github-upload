...
<%
    ...
    String strConProjCodeData = getField(request.getParameter( "hidConProjCode" ));
    ...
    String strFieldAccessDocTypeData = "";
    ...
    if( strMode.equals("PERMIT") ) {
    	con.addData( "PROJECT_CODE_CON", "String", strConProjCodeData );
		...
		bolnSuccess = con.executeService( strContainerName, strClassName, "commitRightsUserGroup" );
		if( !bolnSuccess ){
    ...
    if( strMode.equals("UNPERMIT") ) {
        ...
        con.addData( "ADD_DATE",         "String", strCurrentDate);
        con.addData( "UPD_USER",         "String", strUserId);
		bolnSuccess = con.executeService( strContainerName, strClassName, "cancelRightUsergroup" );
		if( !bolnSuccess ){
			strmsg  = "showMsg(0,0,\" " + lc_can_not_update_data + "\")";
			strMode = "SEARCH";
		}else{
    ...
    if( strMode.equals("SEARCH") ) {
    	...
    	bolnSuccess = con.executeService( strContainerName, strClassName, "findAllProjectCodePermit" );
...
//			form1.sortby.value              = form1.sortby_parent.value;
		    ...
		    form1.PAGE_KEY.value            = "user_group5.jsp";
...
<body onLoad="MM_preloadImages('images/btt_commitrights_over.gif','images/btt_cancelright_over.gif','images/btt_back_over.gif');window_onload();" onresize="set_background()">
...
%>
                      ...
                      <tr class="hd_table"> 
                        ...
                        <td width="170" align="center">
                        	<div align="center"><span id="lb_doc_cabinet"></span><%=sortimg[1]%></div>
                        </td>
                        <td width="240" align="center">
                        	<div align="center"><span id="lb_user_cabinet"></span><%=sortimg[2]%></div>
                        </td>
...
<%
    ...
    if( (bolnSuccess) ) {
        ...
        while( con.nextRecordElement() ) {
            ...
            bolnSuccess2 = con2.executeService( strContainerName, strClassName, "findAllUserRolePermit" );
            if( bolnSuccess2 ) {
	            ...
	            strFieldAccessDocTypeData = con2.getHeader( "ACCESS_DOC_TYPE" );
            }else {
            	strFieldUserRoleData      = "";
            	strFieldRoleNameData      = "";
            	strFieldAccessTypeData    = "";
            	strFieldAccessDocTypeData = "";
            }
			...
			strScript  += "ACCESS_TYPE=\"" + strFieldAccessTypeData + "\" ACCESS_DOC_TYPE=\"" + strFieldAccessDocTypeData + "\" ";
			if( bolnSuccess2 ) {
...
%>
                      <tr class="table_data1">
                        <td>&nbsp;</td>
                        <td>
                        	<div align="center"><input type="checkbox" id="chkAllCheck<%=intSeq%>" name="chkAllCheck<%=intSeq%>" onclick="chkbxClickValue()" ></div>
                        </td>
