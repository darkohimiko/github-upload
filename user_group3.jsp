...
<%
    ...
    String strConcatUserIdDel  = getField(request.getParameter( "hidConUserId" ));
    ...
    if( strMode.equals("DELETE") ) {
    	con.addData( "USER_ID", "String", strConcatUserIdDel );
		bolnSuccess = con.executeService( strContainerName, strClassName, "deleteUserIdFromGroup" );
		if( !bolnSuccess ){
  ...
  <tr>
    <td valign="top">
    	<table width="800" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="25" class="label_header01" >&nbsp;&nbsp;<%=screenname%>&nbsp;<%=lb_user_group_manage %></td>
              </tr>
              <tr> 
                <td><div align="center">
 ...
 %>                      
                    ...
                    <p>
		           		<a href="#" onclick= "buttonClick('add')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add','','images/btt_add_over.gif',1)">
		           			<img src="images/btt_add.gif" name="add" width="67" height="22" border="0"></a>&nbsp;
		           		<a href="#" onclick= "buttonClick('del')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('del','','images/btt_del_over.gif',1)">
		           			<img src="images/btt_del.gif" name="del" width="67" height="22" border="0"></a>&nbsp;
