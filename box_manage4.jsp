...
<%
    ...
    String strYear 	  		= checkNull( request.getParameter( "YEAR" ) );
    String strBoxSeqn 		= checkNull( request.getParameter( "BOX_SEQN" ) );
    ...
    //String strConcatBoxDetail 	= checkNull( request.getParameter( "CONCAT_BOX_DETAIL" ) );        
...
function submit_form(){
	form1.method = "post";
	form1.action = "box_manage5.jsp";
	form1.submit();
}

function clear_search_data(){
	form1.BATCH_NO_LINK.value 	= "";
...
function set_document_data_field(){
	...
	if(form1.BATCH_NO_LINK.value != ""){
		objConditionList = form1.selConditionA;		
		strConcatFieldValue +=  " " + strMasterScan + "BATCH_NO='" + form1.BATCH_NO_LINK.value + "' " + objConditionList.value;
	}
...
function set_concat_document_field(){
	...
	for( var intCount = 0 ; intCount < arrField.length ; intCount++ ){
		...
		if( objDocumentField != null && objDocumentField.name.indexOf( "DSP_" ) == -1 && objDocumentField.value.length > 0 ){
			...
			if(((objDocumentField.getAttribute("value_type") == "date")&&(strConcatToDateFieldValue != ""))||((objDocumentField.getAttribute("value_type") == "date_eng")&&(strConcatToDateFieldValue != ""))){
...
function window_onload() {
	...
	if(strMethod == "SEARCH_TOTAL"){
		change_tab_search('div_search_all','txt_searchtotal');
	}else if(strMethod == "SEARCH_INDEX"){
		change_tab_search('div_search_index','txt_search');
	}
	change_tab_img();
}
			              	...
			              	<tr> 
			                	...
			                	<td width="*"><div class="label_bold1"> 
			                    	<div align="right" style="padding-right: 30px"><span class="label_header02" title="<%=strProjectCode %>"><%=strProjectName %></span><br>
			                      		<span class="label_bold5">(<%=lb_search_data_box %>)</span></div>
			                  		</div>
			                  	</td>
			              	</tr>
	            		</table>
...
<%
				...
				strButtSearch += "<a href=\"javascript:change_tab_search('div_search_index','txt_search')\" onMouseOut=\"change_tab_img()\" onMouseOver=\"MM_swapImage('search_detail','','images/txt_search_over.gif',1)\"><img id=\"txt_search\" src=\"images/txt_search.gif\" name=\"search_detail\" width=117 height=25 border=0></a>";
				strButtSearch += "<span style=\"display:" + strDisplayTab + "\"><a href=\"javascript:change_tab_search('div_search_all','txt_searchtotal')\" onMouseOut=\"change_tab_img()\" onMouseOver=\"MM_swapImage('searchtotal','','images/txt_searchtotal_over.gif',1)\"><img id=\"txt_searchtotal\" src=\"images/txt_searchtotal.gif\" name=\"searchtotal\" width=117 height=25 border=0></a></span>";
				...
				<!-- ---------------------------------- DIV DATA-------------------------------------------- -->
					                ...
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
				                    	<tr> 
					                      	...
					                      	<td width="184"><input name="BATCH_NO_LINK" type="text" class="input_box" maxlength="12" onkeypress="keypress_number();field_press( this );"></td>
					                      	<td width="275">&nbsp;</td>
					                      	<td width="72"><select name="selConditionA" class="combobox">
					                    ...
					                    <tr> 
					                      	...
					                      	<td width="459" colspan="2"><input name="DOCUMENT_NAME" type="text" class="input_box" maxlength="500" size="55" onkeypress="field_press( this );"></td>
					                      	<!-- td width="275">&nbsp;</td -->
					                      	<td width="72"><select name="selConditionE" class="combobox">
						                          	<option value="AND">AND</option>
					                          		<option value="RUE">OR</option>
				                        		</select>
			                        		</td>
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input name="ADD_DATE" type="text" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                        	<a href="javascript:showCalendar(form1.ADD_DATE,<%=strLangFlag %>)"><img src="images/calendar.gif" width=16 height=16 align="absmiddle" border=0 ></a> 
				                       			<%=lb_to_date %> </td>
					                      	<td><input name="TO_ADD_DATE" type="text" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                      	...
					                      	<td><select name="selConditionB" class="combobox">
						                          	<option value="AND">AND</option>
					                          		<option value="RUE">OR</option>
				                        		</select> 
				                        	</td>
					                    ...
					                    <tr> 
					                      	<td><%=lb_edit_date %></td>
					                      	<td><input name="EDIT_DATE" type="text" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
				                        		...
				                        		<%=lb_to_date %> </td>
					                      	<td><input name="TO_EDIT_DATE" type="text" class="input_box" maxlength="8" onkeypress="keypress_number();field_press( this );" onBlur="set_format_date( this );"> 
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input id="txtDocUser" name="txtDocUser" type="text" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td>
					                      		<input id="txtDocUserName" name="txtDocUserName" type="text" class="input_box_disable" size="45" readonly>
					                    ...
					                    <tr> 
					                      	...
					                      	<td><input id="ADD_USER" name="ADD_USER" type="text" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td><input id="ADD_USER_NAME" name="ADD_USER_NAME" type="text" class="input_box_disable" size="45" readonly></td>
				                    	...
				                    	<tr> 
					                      	<td><%=lb_edit_user %></td>
					                      	<td><input id="EDIT_USER" name="EDIT_USER" type="text" class="input_box_disable" size="25" readonly> 
					                      	...
					                      	<td><input id="EDIT_USER_NAME" name="EDIT_USER_NAME" type="text" class="input_box_disable" size="45" readonly></td>
					                      	<td>
		...
		if(bolFieldSuccess) {
			...
			while( con.nextRecordElement() ){
				...
				if( strFieldType.equals( "CHAR" ) ){
					...
					boolean bolnZoomSuccess = con2.executeService( strContainerName , "IMPORTDATA" , "findMonthCombo" );		
					if( bolnZoomSuccess ){
						while( con2.nextRecordElement() ){
							strZoomDisplayValue = con2.getColumn( "MONTH" );
							strZoomDisplayText  = con2.getColumn( "MONTH_NAME" );
					...
					con2.addData( "TABLE_ZOOM" , "String" , "MONTH_ENG" );
					
					boolean bolnZoomSuccess = con2.executeService( strContainerName , "IMPORTDATA" , "findTableCode" );		
					if( bolnZoomSuccess ){
						while( con2.nextRecordElement() ){
							strZoomDisplayValue = con2.getColumn( "MONTH_ENG" );
							strZoomDisplayText  = con2.getColumn( "MONTH_ENG_NAME" );
					...
					if(strTableLevel.equals("2")){
						...
						con2.addData("TABLE_CODE"  , "String", strTableLevel1);
					    boolean bolSuccessLv2 = con2.executeService(strContainerName, "IMPORTDATA", "findFieldTableZoom");
					    if(bolSuccessLv2){
					    	strTableLv1 	 = con2.getHeader("FIELD_CODE");
					    	strTableLv1Label = con2.getHeader("FIELD_LABEL");
					...
					if(strTableLevel.equals("3")){
						con2.addData("PROJECT_CODE", "String", strProjectCode);
						con2.addData("TABLE_CODE"  , "String", strTableLevel1);
					    boolean bolSuccessLv3 = con2.executeService(strContainerName, "IMPORTDATA", "findFieldTableZoom");
					    if(bolSuccessLv3){
					    	strTableLv1 	 = con2.getHeader("FIELD_CODE");
					    	strTableLv1Label = con2.getHeader("FIELD_LABEL");
					    ...
					    con2.addData("PROJECT_CODE", "String", strProjectCode);
						con2.addData("TABLE_CODE"  , "String", strTableLevel2);
						
					    bolSuccessLv3 = con2.executeService(strContainerName, "IMPORTDATA", "findFieldTableZoom");
					    if(bolSuccessLv3){
					    	strTableLv2 	 = con2.getHeader("FIELD_CODE");
					    	strTableLv2Label = con2.getHeader("FIELD_LABEL");
					...
					con2.addData( "TABLE_ZOOM" , "String" , strFieldTableZoom );
		
					boolean bolnZoomSuccess = con2.executeService( strContainerName , "IMPORTDATA" , "findTableCode" );
		
					if( bolnZoomSuccess ){
						while( con2.nextRecordElement() ){
							strZoomDisplayValue = con2.getColumn( strFieldTableZoom );
							strZoomDisplayText  = con2.getColumn( strFieldTableZoom + "_NAME" );
...
%>					                    	
				...
				<!-- ---------------------------------- DIV DOCUMENT -------------------------------------------- -->			                
					                ...
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
			                    		<tr> 
						                    ...
						                    <td colspan="2"><input name="txtDOCUMENT_DESC" type="text" class="input_box" size="56" onkeypress="field_press(this)"><input name="DOCUMENT_DESC" type="hidden"></td>
						                    <td width="72">
     ...
     <!-- ########################################## SEARCH TOTAL ############################################## -->
      	...
      	<div id="div_search_all" style="display:none">
      		<table width="790" border="0" cellspacing="0" cellpadding="0">
		        <tr> 
		          	<td>
						<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
				                ...
				                <td bgcolor="#f7f6f2">
					                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="label_bold2">
			                    		<tr> 
						                    ...
						                    <td colspan="3">
						                    	<input name="txtSEARCH_DESC" type="text" class="input_box" size="100" onkeypress="field_press(this)">
...
<input type="hidden" name="BOX_SEQN" 	value="<%=strBoxSeqn%>">
...
<input type="hidden" name="PROJECT_CODE_LINK"	value="<%=strProjectCode %>" />
<input type="hidden" name="PROJECT_NAME_LINK" 	value="<%=strProjectName %>" />
