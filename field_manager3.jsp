...
<%
    ...
    String  screenLabel     = lb_key_field;
    ...
    if( strMode.equals("SETKEY") ) {
        ...
        con1.addData( "INDEX_TYPE",   "String", "K" );
...
//        	else {
//        		strFieldIndexOrder = "0000000" + strFieldIndexOrder;
//        	}
//        	strFieldIndexOrder = strFieldIndexOrder.substring(strFieldIndexOrder.length()-8,strFieldIndexOrder.length());
        }
        ...
        con.addData( "INDEX_TYPE",   "String", "K" );
        con.addData( "IS_PK",        "String", "Y" );
        ...
        bolnSuccess = con.executeService( strContainerName, strClassName, "setIndexFieldManager" );
    ...
    if( strMode.equals("UNSETKEY") ) {
        ...
        bolnSuccess = con.executeService( strContainerName, strClassName, "unSetIndexFieldManager" );
...
function window_onload() {
	...
	lb_key_field.innerHTML          = lbl_key_field
    ...
    if( lastRowSelect2 != "" ) {
    	rowSelected( "typeK", lastRowSelect2 );
    }else {
...
function afterCheckSelect( lv_result ) {
	if( lv_result == "true" ) {
		...
		//alert("ø‘≈¥Ïπ’È∂Ÿ°‡≈◊Õ°‡ªÁπ§’¬Ïø‘≈¥Ï·≈È«");
		alert( lc_this_field_selected_key_field );
	}
}
...
%>
            ...
            <tr>
	           	<td align="center" colspan="4">
	           		<a href="#" onclick= "buttonBack()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/btt_back_over.gif',1)">
